...
class Blogs(models.Model):
	...
	blog_id2 = models.CharField(max_length=100,default='')
	shop = models.ForeignKey(User, on_delete=models.CASCADE,default='')
	...
	pub_date = models.DateField(auto_now=True)
	image1 = models.ImageField(upload_to='blogs/images', default="",null=True)
	image2 = models.ImageField(upload_to='blogs/images', default="",null=True,blank=True)
	image3 = models.ImageField(upload_to='blogs/images', default="",null=True,blank=True)
...
class Blogs_Analysis(models.Model):
	user = models.ForeignKey(User, on_delete=models.CASCADE)
